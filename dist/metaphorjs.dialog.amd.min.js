define("metaphorjs-dialog",function(){function ha(c){if(null===c||"object"!=typeof c)return!1;c=ia(c);return 2<c||-1==c}function u(c){return"function"==typeof c}function z(c){return"string"===typeof c||c===""+c}function S(c){return"object"===typeof c&&5===ia(c)}function Z(c){if(c&&void 0!=!c.length&&c!==""+c){for(var a=[],b=-1,d=c.length>>>0;++b!==d;a[b]=c[b]);return a}return c?[c]:[]}function ca(c){return"object"==typeof c&&3===ia(c)&&!c.nodeType&&c.constructor===Object}function ja(c){return!0===
c||!1===c}function A(){var c=!1,a=!1,b=Z(arguments),d=b.shift(),f,k,g;ja(b[b.length-1])&&(c=b.pop());ja(b[b.length-1])&&(a=c,c=b.pop());for(;f=b.shift();)for(k in f)if(f.hasOwnProperty(k)&&void 0!==(g=f[k]))if(a)if(d[k]&&ca(d[k])&&ca(g))A(d[k],g,c,a);else{if(!0===c||void 0==d[k])ca(g)?(d[k]={},A(d[k],g,c,!0)):d[k]=g}else if(!0===c||void 0==d[k])d[k]=g;return d}function R(){}function Fa(c,a){var b=function(){};b.prototype=c.prototype;b=new b;c=c.apply(b,a);return ha(c)||!1===c?c:b}function Ga(c,a,
b,d,f,k){f=f||"before";return function(){if("instead"==f)return a.apply(b||d,arguments);if("before"==f){var g=a.apply(b||d,arguments);var e=!1!==g?c.apply(d||b,arguments):null}else e=c.apply(d||b,arguments),g=a.apply(b||d,arguments);return k?g:e}}function H(c,a,b,d){return setTimeout(function(){c.apply(a,b||[])},d||0)}function ua(c,a){if(!c||!z(c))return null;try{var b=new DOMParser;var d=b.parseFromString(c,a||"text/xml")}catch(f){L(f),d=void 0}if(!d||d.getElementsByTagName("parsererror").length)throw Error("Invalid XML: "+
c);return d}function U(c){if(!c)return!1;var a;if("object"!=(a=typeof c)&&"function"!=a)return!1;c=c.then;return u(c)?c:!1}function ka(){return!1}function la(){return!0}function W(c){return c.substr(0,1).toUpperCase()+c.substr(1)}var m={plugin:{},mixin:{},lib:{},dom:{},regexp:{},browser:{}},pa=m.lib.Cache=function(){var c,a=function(a){var d={},b=[];0==arguments.length&&(a=!0);return{addFinder:function(a,d,e){b[e?"unshift":"push"]({fn:a,context:d})},add:function(b,f,e){if(d[b]&&!1===d[b].rewritable)return d[b];
d[b]={rewritable:"undefined"!=typeof e?e:a,value:f};return f},get:function(a,f){if(!d[a]){if(b.length){var e;var h=0;for(e=b.length;h<e;h++){var c=b[h].fn.call(b[h].context,a,this);if(void 0!==c)return this.add(a,c,!0)}}return void 0!==f?this.add(a,f):void 0}return d[a].value},remove:function(a){var b=d[a];b&&!0===b.rewritable&&delete d[a];return b?b.value:void 0},exists:function(a){return!!d[a]},eachEntry:function(a,b){for(var e in d)a.call(b,d[e].value,e)},clear:function(){d={}},$destroy:function(){this===
c&&(c=null);this.remove=this.exists=this.destroy=this.get=this.add=a=d=null}}};a.global=function(){c||(c=new a(!0));return c};return a}(),Ha=Object.prototype.toString,ia=function(){var c={"[object String]":0,"[object Number]":1,"[object Boolean]":2,"[object Object]":3,"[object Function]":4,"[object Array]":5,"[object RegExp]":9,"[object Date]":10};return function(a){if(!a){if(null===a)return 6;if(void 0===a)return 7}var b=c[Ha.call(a)];return void 0===b?-1:1===b&&isNaN(a)?8:b}}(),qa=m.lib.Namespace=
function(c){c=c||{};var a=new pa(!1),b=function(b,f){var d=a.get(b);if(void 0!==d||f)return d;f=b.split(".");var g=f.length,e=c;for(d=0;d<g;d++){var h=f[d];if(void 0===e[h])return;e=e[h]}e&&a.add(b,e);return e};this.register=function(b,f){var d=b.split("."),g=d.pop();var e=d.join(".");var h=d.length,l=c;if(a[e])b=[a[e],g,b];else{if(0<h)for(e=0;e<h;e++){var n=d[e];void 0===l[n]&&(l[n]={});l=l[n]}b=[l,g,b]}d=b[0];g=b[1];ha(d)&&void 0===d[g]&&(d[g]=f,a.add(b[2],f));return f};this.exists=function(a){return void 0!==
b(va,!0)};this.get=b;this.add=function(b,f){return a.add(b,f)};this.remove=function(b){return a.remove(b)};this.makeAlias=function(b,f){b=a.get(b);void 0!==b&&a.add(f,b);return b};this.$destroy=function(){var b;a.eachEntry(function(a){a&&a.$destroy&&a.$destroy()});a.$destroy();a=null;for(b in this)this[b]=null}},M=function(){var c=function(){this.$super&&this.$super!==R&&this.$super.apply(this,arguments)},a=function(a,b,d){var $super=a.prototype[b]||("$constructor"===b?a:R)||R;return function(){var a=
this.$super;if(this.$destroyed)return this.$super=null;this.$super=$super;var b=d.apply(this,arguments);this.$super=a;return b}},b=function(b,d,c,e){var h,f=c.prototype;for(h in d)if(d.hasOwnProperty(h)){var g=f[h];var q=d[h];b[h]=!u(q)||g&&!u(g)?q:a(c,h,q)}e||(b.$plugins=null,b.$pluginMap=null,f.$beforeInit?(b.$beforeInit=f.$beforeInit.slice(),b.$afterInit=f.$afterInit.slice(),b.$beforeDestroy=f.$beforeDestroy.slice(),b.$afterDestroy=f.$afterDestroy.slice()):(b.$beforeInit=[],b.$afterInit=[],b.$beforeDestroy=
...
function(){g.$destroy();g=null;a&&(a.$destroy(),a=null)};return e};return d}(),va=function(){var c=new qa;c.register("MetaphorJs",m);c.register("mjs",m);return c}(),I=M(va),fa=function(){var c=["0","0","0"];return function(){for(var a=c.length,b;a;){a--;b=c[a].charCodeAt(0);if(57==b)return c[a]="A",c.join("");if(90==b)c[a]="0";else return c[a]=String.fromCharCode(b+1),c.join("")}c.unshift("0");return c.join("")}}();m.dom=m.dom||{};var t=m.dom.getAttr=function(c,a){return c.getAttribute?c.getAttribute(a):
null},L=function(){var c=[],a=function(a){var b;var f=0;for(b=c.length;f<b;f++)c[f][0].call(c[f][1],a);"undefined"!=typeof console&&console.error&&console.error(a)};a.on=function(b,d){a.un(b,d);c.push([b,d])};a.un=function(a,d){var b;var k=0;for(b=c.length;k<b;k++)if(c[k][0]===a&&c[k][1]===d){c.splice(k,1);break}};return a}(),J=m.dom.select=function(){var c=/^[\w[:#.][\w\]*^|=!]*$/,a=/=([^\]]+)/,b=/ *, */,d=/(\([^)]*)\+/,f=/(\[[^\]]+)~/,k=/(~|>|\+)/,g=/ +/,e=/([^[:.#]+)?(?:#([^[:.#]+))?(?:\.([^[:.]+))?(?:\[([^!&^*|$[:=]+)([!$^*|&]?=)?([^:\]]+)?\])?(?::([^(]+)(?:\(([^)]+)\))?)?/,
...
T=0;r=p.exec(v);v=r[1];var t=r[2]||"";for(F=r[3];r=z[T++];)y[t]&&(y[t](r,v,F)||"class"===v&&y[t](r,"className",F))&&(D[C++]=r);D=C?D:[];break;default:D=Z((D=r.getElementsByTagName(v)).length?D:[])}else{for(var J=v.split(b),N=J.length-1,P=!!N,O,R,G,Q,H,I,K,M,V,E,S,U;C=J[N--];){R=(O=C.replace(d,"$1%").replace(f,"$1&").replace(k," $1 ").split(g)).length;T=0;Q=" ";for(z=r instanceof DocumentFragment?r.children:[r];G=O[T++];)if(" "!==G&&">"!==G&&"~"!==G&&"+"!==G&&z){G=G.match(e);H=G[1]||"*";I=G[2];K=G[3]?
" "+G[3]+" ":"";v=G[4];t=G[5]||"";u=G[7];A="nth-child"===u||"nth-last-child"===u?h.exec("even"===G[8]&&"2n"||"odd"===G[8]&&"2n%1"||!l.test(G[8])&&"0n%"+G[8]||G[8]):G[8];M=[];C=V=0;for(S=T===R;E=z[V++];)switch(Q){case " ":if(E.getElementsByTagName)for(U=E.getElementsByTagName(H),E=0;F=U[E++];)I&&F.id!==I||K&&-1==(" "+F.className+" ").indexOf(K)||!(!v||y[t]&&(y[t](F,v,G[6])||"class"===v&&y[t](F,"className",G[6])))||F.yeasss||(w[u]?w[u](F,A):u)||(S&&(F.yeasss=1),M[C++]=F);break;case "~":for(H=H.toLowerCase();(E=
E.nextSibling)&&!E.yeasss;)1!==E.nodeType||"*"!==H&&E.nodeName.toLowerCase()!==H||I&&E.id!==I||K&&-1===(" "+E.className+" ").indexOf(K)||!(!v||y[t]&&(y[t](F,v,G[6])||"class"===v&&y[t](F,"className",G[6])))||E.yeasss||(w[u]?w[u](E,A):u)||(S&&(E.yeasss=1),M[C++]=E);break;case "+":for(;(E=E.nextSibling)&&1!==E.nodeType;);!E||E.nodeName.toLowerCase()!==H.toLowerCase()&&"*"!==H||I&&E.id!==I||K&&-1===(" "+F.className+" ").indexOf(K)||!(!v||y[t]&&(y[t](F,v,G[6])||"class"===v&&y[t](F,"className",G[6])))||
E.yeasss||(w[u]?w[u](E,A):u)||(S&&(E.yeasss=1),M[C++]=E);break;case ">":if(E.getElementsByTagName)for(U=E.getElementsByTagName(H),T=0;F=U[T++];)F.parentNode!==E||I&&F.id!==I||K&&-1==(" "+F.className+" ").indexOf(K)||!(!v||y[t]&&(y[t](F,v,G[6])||"class"===v&&y[t](F,"className",G[6])))||F.yeasss||(w[u]?w[u](F,A):u)||(S&&(F.yeasss=1),M[C++]=F)}z=M}else Q=G;if(P){if(!z.concat){M=[];for(E=0;F=z[E];)M[E++]=F;z=M}D=z.concat(1===D.length?D[0]:D)}else D=z}for(C=D.length;C--;)D[C].yeasss=D[C].nodeIndex=D[C].nodeIndexLast=
...
b;b=a.shift();)try{b[0].call(b[1]||null,this._value)}catch(l){L(l)}},done:function(a,b){var e=this._state;if(1===e&&0===this._wait)try{a.call(b||null,this._value)}catch(n){L(n)}else 0===e&&this._dones.push([a,b]);return this},_fail:function(){for(var a=this._fails,b;b=a.shift();)try{b[0].call(b[1]||null,this._reason)}catch(l){L(l)}},fail:function(a,b){var e=this._state;if(2===e&&0===this._wait)try{a.call(b||null,this._reason)}catch(n){L(n)}else 0===e&&this._fails.push([a,b]);return this},always:function(a,
...
p.filter.apply(p.filterContext||p.context,b)||(p.count++,p.count<p.start))){if(p.async&&!g){var x=null;H(p.fn,p.context,b,p.async)}else g?(x=function(e,b,d){return function(c){"pipe"===b&&(d[0]=c,d=a._prepareArgs(e,d));return e.fn.apply(e.context,d)}}(p,d,l.slice()),x=n?n.then(x):p.fn.apply(p.context,b),x.catch(L)):x=p.fn.apply(p.context,b);p.called++;p.called===p.limit&&a.un(p.id);if("first"===d)return x;if(g)h.push(x),("pipe"===d||e)&&x&&(n=x);else if(null!==d)if("all"===d)q.push(x);else if("concat"===
...
!0,!1);return c}(),O=m.dom.setAttr=function(c,a,b){return c.setAttribute(a,b)};m.ajax=m.ajax||{transport:{}};var ya=m.ajax.serializeParam=function(){function c(a,f,k){var d;if(S(f)){var e=0;for(d=f.length;e<d;e++){var h=f[e];b.test(a)?k(a,h):c(a+"["+("object"===typeof h?e:"")+"]",h,k)}}else if(ca(f))for(e in f)c(a+"["+e+"]",f[e],k);else k(a,f)}var a=/%20/g,b=/\[\]$/;return function(b){var d,k=[],g=function(a,b){b=u(b)?b():null==b?"":b;k[k.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};for(d in b)c(d,
b[d],g);return k.join("&").replace(a,"+")}}(),Ka=m.ajax.transport.XHR=function(){var c={xml:"application/xml, text/xml",html:"text/html",script:"text/javascript, application/javascript",json:"application/json, text/javascript",text:"text/plain",_default:"*/*"};return I({type:"xhr",_xhr:null,_deferred:null,_ajax:null,$init:function(a,b,d){var c;window.XMLHttpRequest&&(c=new XMLHttpRequest)||(c=new ActiveXObject("Msxml2.XMLHTTP"));this._xhr=c;this._deferred=b;this._opt=a;this._ajax=d;a.progress&&(c.onprogress=
...
c._default);for(d in a.headers)b.setRequestHeader(d,a.headers[d])},onReadyStateChange:function(){var a=this._xhr,b=this._deferred;if(0===a.readyState)a.onreadystatechange=R,b.resolve(a);else if(4===a.readyState){a.onreadystatechange=R;a:{try{var d=!a.status&&location&&"file:"===location.protocol||200<=a.status&&300>a.status||304===a.status||1223===a.status;break a}catch(f){L(f)}d=!1}if(d)this._ajax.processResponse(z(a.responseText)?a.responseText:void 0,a.getResponseHeader("content-type")||"");else{a.responseData=
null;try{a.responseData=this._ajax.returnResponse(z(a.responseText)?a.responseText:void 0,a.getResponseHeader("content-type")||"")}catch(f){L(thrownError)}b.reject(a)}}},abort:function(){this._xhr.onreadystatechange=R;this._xhr.abort()},send:function(){var a=this._opt;try{this._xhr.open(a.method,a.url,!0,a.username,a.password),this.setHeaders(),this._xhr.send(a.data)}catch(b){L(b),this._deferred&&this._deferred.reject(b)}}})}(),La=m.lib.DomEvent=function(){var c=function d(b){if(b instanceof d)return b;
...
d);h=Math[1<=h?"floor":"ceil"](h/d);l=Math[1<=l?"floor":"ceil"](l/d);this.getBoundingClientRect&&(B=this.getBoundingClientRect(),k=g.clientX-B.left,q=g.clientY-B.top);g.deltaX=h;g.deltaY=l;g.deltaFactor=d;g.offsetX=k;g.offsetY=q;g.deltaMode=0;e.unshift(g,p,h,l);b&&clearTimeout(b);b=setTimeout(a,200);return c.apply(this,e)}}};c.events=function(){var a=window.document;return"onwheel"in a||9<=a.documentMode?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"]};return c}(),P=m.dom.addListener=
function(){var c=null,a=null;return function(b,d,f){null===c&&(b.addEventListener?(c="addEventListener",a=""):(c="attachEvent",a="on"));if("mousewheel"==d){f=za(f);d=za.events();var k;var g=0;for(k=d.length;g<k;g++)b[c](a+d[g],f,!1)}else b[c](a+d,f,!1);return f}}(),Ma=m.ajax.transport.Script=I({type:"script",_opt:null,_deferred:null,_ajax:null,_el:null,$init:function(c,a,b){this._opt=c;this._ajax=b;this._deferred=a},send:function(){var c=document.createElement("script");O(c,"async","async");O(c,"charset",
"utf-8");O(c,"src",this._opt.url);P(c,"load",this.onLoad.bind(this));P(c,"error",this.onError.bind(this));document.head.appendChild(c);this._el=c},onLoad:function(c){this._deferred&&this._deferred.resolve(c)},onError:function(c){this._deferred.reject(c)},abort:function(){this._el.parentNode&&this._el.parentNode.removeChild(this._el)},onDestroy:function(){this._el.parentNode&&this._el.parentNode.removeChild(this._el)}}),Na=m.ajax.transport.IFrame=I({type:"iframe",_opt:null,_deferred:null,_ajax:null,
_el:null,_sent:!1,$init:function(c,a,b){this._opt=c;this._ajax=b;this._deferred=a},send:function(){var c=this,a=document.createElement("iframe"),b="frame-"+fa(),d=c._opt.form;O(a,"id",b);O(a,"name",b);a.style.display="none";document.body.appendChild(a);O(d,"action",c._opt.url);O(d,"target",b);P(a,"load",c.onLoad.bind(c));P(a,"error",c.onError.bind(c));c._el=a;var f=0,k=function(){f++;try{d.submit(),c._sent=!0}catch(g){L(g),2<f?c._deferred.reject(g):H(k,null,[],1E3)}};k()},onLoad:function(){var c=
this._el;if(this._sent&&this._opt&&!this._opt.jsonp)try{var a=c.contentDocument||c.contentWindow.document;var b=a.body.innerHTML;this._ajax.processResponse(b)}catch(d){L(d),this._deferred.reject(d)}},onError:function(c){this._sent&&this._deferred.reject(c)},abort:function(){this._el.parentNode&&this._el.parentNode.removeChild(this._el)},onDestroy:function(){this._el.parentNode&&this._el.parentNode.removeChild(this._el)}}),ea=m.ajax.Ajax=function(){var c=/\?/,a=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,
b=/#.*$/,d=/([?&])_=[^&]*/,f=new xa,k=!(!window||!window.FormData),g=function(a,e,b){var d=e?e.dataType:null;e=e?e.selector:null;if(!z(a))return a;b=b||"";if("xml"===d||!d&&0<=b.indexOf("xml"))return a=ua(a.trim()),e?J(e,a):a;if("html"===d)return a=ua(a,"text/html"),e?J(e,a):a;if("fragment"==d){b=document.createDocumentFragment();d=document.createElement("div");for(d.innerHTML=a;d.firstChild;)b.appendChild(d.firstChild);return b}if("json"===d||!d&&0<=b.indexOf("json"))return JSON.parse(a.trim());
...
a)});this.$$promise.always(function(){f.trigger("end")});f.trigger("start");b.timeout&&(this._timeout=setTimeout(this.onTimeout.bind(this),b.timeout));b.jsonp&&this.createJsonp();!1===f.trigger("before-send",b,g)&&this.$$promise.reject();b.beforeSend&&!1===b.beforeSend.call(b.context,b,g)&&this.$$promise.reject();this.$$promise.isPending()?(H(g.send,g),this.$$promise.always(this.asyncDestroy,this)):H(this.asyncDestroy,this,[],1E3)},asyncDestroy:function(){this.$isDestroyed()||(this.$$promise.hasListeners()?
H(this.asyncDestroy,this,[],1E3):this.$destroy())},abort:function(a){this.$$promise.reject(a||"abort");this._transport.abort();return this},onTimeout:function(){this.abort("timeout")},getTransport:function(){return this._transport},createForm:function(){var a=document.createElement("form");a.style.display="none";O(a,"method",this._opt.method);O(a,"enctype","multipart/form-data");l(this._opt.data,a,null);document.body.appendChild(a);this._form=a;this._removeForm=!0},importFiles:function(){var a=this._opt,
...
c||{};c.form=a;return b(null,c)};b.prepareUrl=function(a,b){return ea.prepareUrl(a,b||{})};return b}(),Q=function(){if("undefined"!==typeof window){var c=window;var a=c.requestAnimationFrame||c.webkitRequestAnimationFrame||c.mozRequestAnimationFrame;var b=c.cancelAnimationFrame||c.webkitCancelAnimationFrame||c.mozCancelAnimationFrame||c.webkitCancelRequestAnimationFrame;if(a)return function(c,f,k){var d=a(f||k?function(){c.apply(f,k||[])}:c);return function(){b(d)}}}return function(a,b,c){var d=H(a,
b,c,0);return function(){clearTimeout(d)}}}(),Pa=function(){var c=/((^|[^a-z0-9_$\]\)'"])|(this))(\.)([^0-9])/ig,a=Function,b={},d=0,f={},k=0,g={},e=0,h=function(){1E3<=d&&(b={});1E3<=k&&(f={});1E3<=e&&(g={})};return{createGetter:function(e,h){try{if(!b[e]||h){d++;var f="".concat("try {","return ",e.replace(c,"$2____.$5"),";} catch (thrownError) { /*DEBUG-START*/console.log(thrownError);/*DEBUG-END*/return undefined; }");return h?"function(____) {"+f+"}":b[e]=new a("____",f)}return b[e]}catch(p){return L(p),
R}},createSetter:function(b,e){try{if(!f[b]||e){k++;var d=b.replace(c,"$2____.$5"),h="".concat("try {",d," = $$$$",";} catch (thrownError) { /*DEBUG-START*/console.log(thrownError);/*DEBUG-END*/return undefined; }");return e?"function(____, $$$$) {"+h+"}":f[b]=new a("____","$$$$",h)}return f[b]}catch(B){return L(B),R}},createFunc:function(b,d){try{if(!g[b]||d){e++;var h="".concat("try {",b.replace(c,"$2____.$5"),";} catch (thrownError) { /*DEBUG-START*/console.log(thrownError);/*DEBUG-END*/return undefined; }");
return d?"function(____) {"+h+"}":g[b]=new a("____",h)}return g[b]}catch(p){return L(p),R}},resetCache:h,enableResetCacheInterval:function(){setTimeout(h,1E4)}}}().createGetter;m.dialog=m.dialog||{pointer:{},position:{}};var Aa=m.dom.getClsReg=function(c){c="(?:^|\\s)"+c+"(?!\\S)";var a=pa.global(),b="regex_"+c;return a.get(b)||a.add(b,new RegExp(c))},Ba=m.dom.hasClass=function(c,a){return a?Aa(a).test(c.className):!1},X=m.dom.addClass=function(c,a){a&&!Ba(c,a)&&(c.className+=" "+a)},aa=m.dom.removeClass=
...
0}c=k;h=h||(q?"border":"content");e=h===(l?"border":"content")?4:"width"===e?1:0;for(q=0;4>e;e+=2)"margin"===h&&(q+=parseFloat(g[h+d[e]])),l?("content"===h&&(q-=parseFloat(g["padding"+d[e]])),"margin"!==h&&(q-=parseFloat(g["border"+d[e]+"Width"]))):(q+=parseFloat(g["padding"+d[e]]),"padding"!==h&&(q+=parseFloat(g["border"+d[e]+"Width"])));g=c+q}return g}};var ma=m.dom.getOuterWidth=M("outer","Width"),na=m.dom.getOuterHeight=M("outer","Height"),Ta=m.dom.delegate=function(c,a,b,d){var f=pa.global().get("dom/delegates",
[]),k=a+"-"+b,g=function(b){b=K(b);for(var e=b.target;e;){if(ra(e,a))return d(b);e=e.parentNode}return null};f[k]||(f[k]=[]);f[k].push({el:c,ls:g,fn:d});P(c,b,g)},N=m.dom.data=function(){var c={};return function(a,b,d){a=a._mjsid||(a._mjsid=fa());var f=c[a];return void 0!==d?(f||(f=c[a]={}),f[b]=d):f?f[b]:void 0}}();m.animate=m.animate||{};var sa=m.animate.getPrefixes=function(){var c=["Moz","Webkit","ms","O","Khtml"],a="animationDelay",b="animationDuration",d="transitionDelay",f="transitionDuration",
...
this.show(a):this[this.visible?"hide":"show"](a,b)},resetHandlers:function(a,b){this.setHandlers("unbind");this.bindSelfOnRender=!1;a&&a.call(b,this,this.getCfg());this.setHandlers("bind")},setHandlers:function(a,b){var e=this.cfg,d=["show","hide","toggle"],h="bind"===a?P:Y;a="bind"===a?Ta:m.dom.undelegate;for(var f,g,k,v,w,u,r,y,t,A;f=d.shift();)if(g=e[f].events,!1!==g){if(z(g)||S(g))this.dynamicTarget?(w={},w[g]=e.target,g={_html:w}):g={_target:g};for(k in g){if(b)if("_self"===b){if("_self"!==k&&
"_overlay"!==k&&">"!==k.substr(0,1))continue}else if(k!==b)continue;if("_self"!==k&&"_overlay"!==k&&">"!==k.substr(0,1)||this.node){if(r=g[k]){switch(k){case "_target":y=[this.getTarget()];break;case "_self":y=[this.node];break;case "_window":y=[window];break;case "_document":y=[window.document];break;case "_html":y=[window.document.documentElement];break;case "_overlay":y=[this.overlay.getElem()];break;default:y=">"===k.substr(0,1)?J(k.substr(1),this.node):J(k)}if(y&&y.length)if(z(r)&&(r=[r]),S(r))for(w=
0,u=r.length;w<u;w++)for(t=-1,A=y.length;++t<A;h(y[t],r[w],this[f+"Delegate"]));else for(v in r)for(t=-1,A=y.length;++t<A;a(y[t],r[v],v,this[f+"Delegate"]));}}else this.bindSelfOnRender=!0}}},onPreventScroll:function(a){K(a).preventDefault()},onButtonClick:function(a){var b=K(a).target;(b=N(b,"metaphorjsTooltip-button-id"))&&this.trigger("button",this,b,a)},onButtonKeyup:function(a){if(13===a.keyCode||32===a.keyCode){var b=N(a.target,"metaphorjsTooltip-button-id");b&&this.trigger("button",this,b,
K(a))}},getEventConfig:function(a,b){var e=this.node;for(var d=a.type,h=a.target,f=null,g;h&&h!==e;){if(g=t(h,"data-"+b+"-"+d)){f=Pa(g)({});break}h=h.parentNode}e=f;d=this.cfg;!e&&d.events[b]&&(e=d.events[b][a.type]||d.events[b]["*"]);return e},show:function(b,d){var e=this.cfg,h=null,f=e.show,g=null;b&&(b=K(b));this.isEnabled()||(g="disabled");!g&&this.visible&&this.hideTimeout&&(window.clearTimeout(this.hideTimeout),this.hideTimeout=H(this.hide,this,null,e.hide.timeout),g="hidetimeout");!g&&this.hideDelay&&
...
h=k.process(this,b,"show",g):(k.stopPropagation&&b.stopPropagation(),k.preventDefault&&b.preventDefault(),h=k.returnValue));if(g)return h;Da(this.node);this.visible=!0;f.single&&a.hideAll(this);this.toggleTitleAttribute(!1);f.delay&&!d?this.showDelay=H(this.showAfterDelay,this,[b],f.delay):this.showAfterDelay(b,d);return h},showAfterDelay:function(a,b){var e=this,d=e.cfg;e.showDelay=null;if(e.visible){e.trigger("show-after-delay",e,a);d.hide.remove&&e.appendElem();e.reposition(a);if(d.show.preventScroll){var h=
d.show.preventScroll,f;!0===h&&(h="body");h=J(h);var g=-1;for(f=h.length;++g<f;P(h[g],"mousewheel",e.onPreventScrollDelegate)&&P(h[g],"touchmove",e.onPreventScrollDelegate));}e.overlay.show();d.show.animate&&!b?e.animate("show").done(function(){e.showAfterAnimation(a)}):Q(function(){e.showAfterAnimation(a)})}},showAfterAnimation:function(a){var b=this.cfg,e=this.node;this.visible&&(aa(e,b.cls.hidden),X(e,b.cls.visible),b.render.keepVisible||(e.style.display=b.show.display||"block"),b.hide.timeout&&
(this.hideTimeout=H(this.hide,this,null,b.hide.timeout)),b.show.focus&&H(this.setFocus,this,null,20),this.trigger("show",this,a))},hide:function(a,b,d){var e=null,h=null,f=this.cfg;this.hideTimeout=null;!this.visible&&this.hideDelay&&b&&(window.clearTimeout(this.hideDelay),this.hideDelay=null,this.visible=!0);this.node&&this.visible&&this.isEnabled()||(h=this.node?this.visible?"disabled":"hidden":"noelem");this.showDelay&&!h&&(f.hide.cancelShowDelay||d?(window.clearTimeout(this.showDelay),this.showDelay=
null,this.visible=!1,h="cancel"):h="delay");this.frozen&&!h&&(h="frozen");h||!1!==this.trigger("before-hide",this,a)||(h="beforehide");var g;a&&a.stopPropagation&&(g=this.getEventConfig(a,"hide"))&&(g.process?e=g.process(this,a,"hide",h):(g.stopPropagation&&a.stopPropagation(),g.preventDefault&&a.preventDefault(),e=g.returnValue));if(h)return e;Da(this.node);this.visible=!1;this.toggleTitleAttribute(!0);this.dynamicTarget&&this.resetDynamicTarget();f.hide.delay&&!b?this.hideDelay=H(this.hideAfterDelay,
this,[a],f.hide.delay):this.hideAfterDelay(a,b);return e},hideAfterDelay:function(a,b){var e=this,d=e.cfg;e.hideDelay=null;if(!e.visible){e.trigger("hide-after-delay",e,a);if(d.show.preventScroll){var h=d.show.preventScroll,f;!0===h&&(h="body");h=J(h);var g=-1;for(f=h.length;++g<f;Y(h[g],"mousewheel",e.onPreventScrollDelegate)&&Y(h[g],"touchmove",e.onPreventScrollDelegate));}e.overlay.hide();d.hide.animate&&!b?e.animate("hide").done(function(){e.hideAfterAnimation(a)}):Q(function(){e.hideAfterAnimation(a)})}},
hideAfterAnimation:function(a){var b=this,e=b.cfg,d=b.node;b.visible||(aa(d,e.cls.visible),X(d,e.cls.hidden),e.render.keepVisible||(d.style.display="none"),b.trigger("hide",b,a),a=e.render.lifetime,null!==a&&(0===a?b.destroyElem():b.destroyDelay=H(b.destroyElem,b,null,a)),d&&e.hide.destroy?Q(function(){N(d,e.instanceName,null);b.$destroy()}):d&&e.hide.remove&&Q(function(){b.removeElem()}))},render:function(){var a=this.cfg;if(!this.node){var b=a.render,d=a.cls;if(b.fn){var f=b.fn.call(this.$$callbackContext,
this);b[z(f)?"tpl":"el"]=f}b.el?z(b.el)?(f=J(b.el).shift(),b.keepInDOM=!0):f=b.el:(f=window.document.createElement("div"),f.innerHTML=b.tpl,f=f.firstChild);f||(f=window.document.createElement("div"));this.node=f;b.id&&O(f,"id",b.id);a.render.keepVisible||(f.style.display="none");X(f,d.dialog);X(f,d.hidden);b.style&&V(f,b.style);this.overlay.render();a.hide.remove?f.parentNode&&f.parentNode.removeChild(f):this.appendElem();b.zIndex&&V(f,{zIndex:b.zIndex});b=a.content;if(!1!==b.value)if(b.value)this.setContent(b.value);
else if(b.fn)this.setContent(b.fn.call(this.$$callbackContext,this));else this[a.ajax.url?"loadContent":"readContent"]();this.pointer.render();this.pointer.append();if(a.buttons)for(var g in a.buttons)if(b=J(a.buttons[g],f).shift())N(b,"metaphorjsTooltip-button-id",g),P(b,"click",this.onButtonClickDelegate),P(b,"keyup",this.onButtonKeyupDelegate);this.bindSelfOnRender&&(this.setHandlers("bind","_self"),this.bindSelfOnRender=!1);this.rendered=!0;this.trigger("render",this)}},setPositionType:function(a){var b=
this.getPositionClass(a);this.cfg.position.type=a;this.positionClass===b&&this.position?this.position.type=a:(this.position&&(this.position.$destroy(),this.position=null),b&&(this.position=I.factory(b,this)));this.isVisible()&&this.reposition()},getPosition:function(a){var b=this.cfg.position;if(!this.position){!this.positionGetType&&"custom"!==b.type&&u(b.get)&&"m"!==b.type&&(b.type="custom");a=this.positionGetType?this.positionGetType.call(this.$$callbackContext,this,a):b.type;var e=this.getPositionClass(a);
b.type=a;if(!1===e)return;this.positionClass!==e?this.position=I.factory(e,this):this.position.type=a}return this.position},getPositionClass:function(a){return a?u(a)||"custom"===a?"dialog_position_Custom":(a=a.substr(0,1))?"w"===a?"dialog_position_Window":"m"===a?"dialog_position_Mouse":"dialog_position_Target":!1:!1},reposition:function(a){this.repositioning||(this.repositioning=!0,a&&(a=K(a)),this.getPosition(a),this.trigger("before-reposition",this,a),this.getPosition(a),this.trigger("reposition",
this,a),this.repositioning=!1)},getTarget:function(){return this.dynamicTarget?this.dynamicTargetEl:this.target},setTarget:function(a){if(a){var b=!1,e=this.target;this.target?(this.setHandlers("unbind","_target"),b=!0):this.dynamicTarget&&(b=!0);var d=z(a);d&&"#"!==a.substr(0,1)?(this.dynamicTarget=!0,this.target=null):(d&&(a=J(a).shift()),this.dynamicTarget=!1,this.target=a);b&&(this.setHandlers("bind","_target"),this.trigger("target-change",this,a,e))}},resetDynamicTarget:function(){var a=this.dynamicTargetEl;
